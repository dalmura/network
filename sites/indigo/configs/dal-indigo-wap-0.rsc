...
/certificate
add name=ca days-valid=10950 common-name=dal-indigo-wap-0.indigo.dalmura.au key-usage=key-cert-sign,crl-sign
add name=server days-valid=10950 common-name=dal-indigo-wap-0.indigo.dalmura.au
